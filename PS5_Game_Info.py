...
#============================================================================lbl_icon0
        ...
        self.lbl_icon0.setPixmap(QtGui.QPixmap(os.path.join(basedir,'images/Nothing.png')))
...
#============================================================================btn_game_path
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/Folder_icon.png')), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
#==========================================================================================actGithub
        ...
        iconGithub.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/GitHub_logo.png')),QtGui.QIcon().Mode.Normal)
...
#==========================================================================================actTelegram
        ...
        iconTelegram.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/Telegram_logo.png')),QtGui.QIcon().Mode.Normal)
...
#==========================================================================================actYoutube
        ...
        iconYoutube.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/YT_logo.png')),QtGui.QIcon().Mode.Normal)
...
#==========================================================================================acOpen
        ...
        iconOpen.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/Folder_icon.png')),QtGui.QIcon().Mode.Normal)
...
#==========================================================================================acClear
        ...
        acClear=QtGui.QIcon()
        acClear.addPixmap(QtGui.QPixmap(os.path.join(basedir,'images/Clear_icon.png')),QtGui.QIcon().Mode.Normal)
...
if __name__ == "__main__":
    ...
    app.setWindowIcon(QtGui.QIcon(os.path.join(basedir,'images/Icon_ps5_info.ico')))
    ui = Ui_PS5_Game_Info()
